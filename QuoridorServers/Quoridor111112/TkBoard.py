...
class TkBoard():
    ...
    def new_game(self, np=2, nai=0):
        ...
        total_height = 11*self.SQUARE_SIZE + 11*self.SQUARE_SPACING + 2*self.MARGIN
...
if __name__ == "__main__":
    ...
    socket_list[0].send('1 11 11 12 120')
    socket_list[1].send('2 11 11 12 120')
    tkb = TkBoard(n, ai)
